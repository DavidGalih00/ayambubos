                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="hal_makanan.php">Daftar Makanan</a>
                                        </li>
                                        <li class="nav-item">
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <h5 class="card-header"><a href="/admin/pages/tables/makanan/hal_makanan.php">Daftar Makanan</a></h5>
                            <div class="card-body">
                                <form action="process/tambah_makanan.php" method="POST" enctype="multipart/form-data">

                                    <?php 
                                    $tampilkan_isi = "select count(id_makanan) as jumlah from makanan;";
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">ID Makanan</label>
                                        <div class="col-md-9">
                                            <input type="text" name="id_makanan" class="form-control" value="M-<?php echo $no+$jumlah ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Nama Makanan</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Deskripsi Makanan</label>
                                        <div class="col-md-9">
                                            <textarea name="deskripsi" cols="30" rows="10" class="form-control"
                                                placeholder="Deskripsi Makanan" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-5">
                                        <div class="col-md-6">
                                            <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg" href="hal_makanan.php"
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            Copyright © 2021 Kelompok 2 All rights reserved.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        </div>
                    </div>
