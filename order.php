	...
	<header class="header">
		...
		<div class="home">
			<div class="home_container">
				<div class="home_background" style="background-image:url(images/order.jpg)"></div>
					...
					<div class="col">
						<table id="tabell" class="table table-striped">
							...
							<tbody>
								<?php
                                            $query = 
                                            "SELECT * FROM transaksi t,makanan b where t.id_customer='$id_customer' AND t.id_makanan = b.id_makanan";
